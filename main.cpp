...
void createSyndiquee() {
    ...
    cout << "Entrez le nom de Famille:" << endl;
    cin >> nom;

    while (!valid) {
        cout << "Entrez le ID:" << endl;
        cin >> id;
    ...
    cout << "Entrez le nombre d'heures travailles: " << endl;
    cin >> nbHeures;

    cout << "Entrez le salaire horaire: " << endl;
    cin >> salHoraire;

    cout << "\nMerci d'avoir ajoute l'employe!\n " << endl;
...
void createContractuelle() {
    ...
    cout << "Entrez le salaire/montant fixe: " << endl;
    cin >> montant;

    cout << "Entrez la quantite de semaines travailles:" << endl;
    cin >> semaines;
...
void createPonctuelle() {
    ...
    cout << "Entrez le montant unique paie: " << endl;
    cin >> montant;
